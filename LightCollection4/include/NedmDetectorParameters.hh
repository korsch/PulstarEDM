...
public:
  ...
  void Compute();
  void Print();
  void GetLightGuideGeometry(std::vector<G4double>& dx, std::vector<G4double>& dy, std::vector<G4double>& dz, std::vector<G4double>& angleX, std::vector<G4double>& angleY );
  ...
  inline G4ThreeVector cell_fb_size() const { return cell_fb_size_; }
  ...
  inline G4double cell_fb_distx() const { return cell_fb_distx_; }
  inline G4double cell_fb_disty() const { return cell_fb_disty_; }
  inline G4double cell_fb_distz() const { return cell_fb_distz_; }
  ...
  inline G4ThreeVector cell_fb_surface_position() const {return cell_fb_surface_position_; }
  ...
  inline G4ThreeVector cell_fb_outside_surface_position() const {return cell_fb_outside_surface_position_; }
  ...
  inline G4ThreeVector cell_wall_fb_position() const {return  cell_wall_fb_position_;}
  ...
  inline G4ThreeVector cell_fb_surface_size() const {return  cell_fb_surface_size_;}
  ...
  inline G4ThreeVector cell_fb_outside_surface_size() const {return  cell_fb_outside_surface_size_;}
  ...
  inline G4double lightguide_topbottom_surface_rotation_angle(size_t k) const { return lightguide_topbottom_surface_rotation_angle_[k]; }
  inline G4double lightguide_leftright_surface_rotation_angle(size_t k) const { return lightguide_leftright_surface_rotation_angle_[k]; }
  inline G4ThreeVector acrylicwindow_frontback_surface_size() const { return acrylicwindow_frontback_surface_size_; }
  inline G4ThreeVector acrylicwindow_frontback_surface_position(size_t k) const { return acrylicwindow_frontback_surface_position_[k]; }
  inline G4ThreeVector acrylicwindow_center_surface_size() const { return acrylicwindow_center_surface_size_; }
  inline G4ThreeVector acrylicwindow_center_surface_position() const { return acrylicwindow_center_surface_position_; }
  ...
  inline G4double acrylicwindow_radius() const { return acrylicwindow_radius_; }
  inline G4double acrylicwindow_z() const { return acrylicwindow_z_; }
  inline G4ThreeVector acrylicwindow_position() const { return acrylicwindow_position_; }
  ...
  inline G4bool use_full_acrylicwindow() const { return use_full_acrylicwindow_; }
  inline G4bool use_acrylicwindow() const { return use_acrylicwindow_; }
  ...
  inline void set_acrylicwindow_radius(G4double acrylicwindow_radius);
  ...
  inline void set_use_acrylicwindow(G4bool use_acrylicwindow); 
  inline void set_use_window(G4bool use_window); 
  inline void set_use_full_acrylicwindow(G4bool use_full_acrylicwindow); 
...
private:
  ...
  void ComputeAcrylicWindowParameters();
  ...
  G4double acrylicwindow_pmt_gap_;
  G4double lightguide_acrylicwindow_gap_;
  ...
  std::vector<G4ThreeVector> acrylicwindow_frontback_surface_position_;

  G4ThreeVector acrylicwindow_center_surface_position_;

  std::vector<G4double> lightguide_topbottom_surface_rotation_angle_;
  std::vector<G4double> lightguide_leftright_surface_rotation_angle_;
  ...
  //! @name Acrylic Window Dimensions
  //@{
  G4double acrylicwindow_radius_;
  G4double acrylicwindow_z_;
  G4ThreeVector acrylicwindow_frontback_surface_size_;
  G4ThreeVector acrylicwindow_center_surface_size_;
  //@}

  G4ThreeVector acrylicwindow_position_;
  ...
  */
  ...
  G4bool use_plug_;
  G4bool use_window_;
  G4bool use_acrylicwindow_;
  G4bool use_full_acrylicwindow_;
...
inline
void NedmDetectorParameters::set_acrylicwindow_radius(G4double acrylicwindow_radius) {
  acrylicwindow_radius_ = acrylicwindow_radius;
}
...
inline
void NedmDetectorParameters::set_use_acrylicwindow(G4bool use_acrylicwindow) {
  use_acrylicwindow_ = use_acrylicwindow; 
}
...
inline
void NedmDetectorParameters::set_use_full_acrylicwindow(G4bool use_full_acrylicwindow) {
  use_full_acrylicwindow_ = use_full_acrylicwindow; 
}
